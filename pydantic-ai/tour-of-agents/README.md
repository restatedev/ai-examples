# Tour of AI Agents with Restate - Pydantic AI

A collection of examples showing how to build resilient AI agents with [Pydantic AI](https://ai.pydantic.dev/) and [Restate](https://restate.dev/).
